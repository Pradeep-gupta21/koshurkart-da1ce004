...
VALUES ('22222222-0000-0000-0000-000000000002', '22222222-0000-0000-0000-000000000002', 'Test Store', 'test_store', 'Test Business', 1000)
...
VALUES ('55555555-0000-0000-0000-000000000005', '44444444-0000-0000-0000-000000000004', '22222222-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'Test Item 1', 1, 10.00, 'requested')
ON CONFLICT DO NOTHING;
...
VALUES ('66666666-0000-0000-0000-000000000006', 'cred1', '22222222-0000-0000-0000-000000000002', '44444444-0000-0000-0000-000000000004', '55555555-0000-0000-0000-000000000005', 'credit', 900, 'confirmed')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.order_items (id, order_id, vendor_id, product_id, title, quantity, price, return_status)
VALUES ('55555555-0000-0000-0000-000000000007', '44444444-0000-0000-0000-000000000004', '22222222-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'Test Item 2', 1, 10.00, 'reversing')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.order_items (id, order_id, vendor_id, product_id, title, quantity, price, return_status)
VALUES ('55555555-0000-0000-0000-000000000008', '44444444-0000-0000-0000-000000000004', '22222222-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'Test Item 3', 1, 10.00, 'escalated')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.order_items (id, order_id, vendor_id, product_id, title, quantity, price, return_status)
VALUES ('55555555-0000-0000-0000-000000000006', '44444444-0000-0000-0000-000000000006', '22222222-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'Test Item 6', 1, 10.00, 'requested')
ON CONFLICT DO NOTHING;
...
-- insert credit ledger to simulate prior success
INSERT INTO public.ledger_entries (id, operation_key, vendor_id, order_id, order_item_id, type, amount_paise, status)
VALUES ('66666666-0000-0000-0000-000000000008', 'cred6', '22222222-0000-0000-0000-000000000002', '44444444-0000-0000-0000-000000000006', '55555555-0000-0000-0000-000000000006', 'credit', 900, 'confirmed')
ON CONFLICT DO NOTHING;
