-- Migration: 20260808191411_fix_approve_return_intent_payment_validation.sql
-- Fixes NULL-unsafe payment status validation in approve_return_intent.
-- Replaces `!= 'success'` with `IS DISTINCT FROM 'success'` to correctly reject NULL values.
...
BEGIN
    ...
    -- 4. Vendor ownership verification (Zero-Trust, under lock)
