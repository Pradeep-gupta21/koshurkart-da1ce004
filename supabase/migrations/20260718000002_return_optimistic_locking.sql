-- Migration: 20260718000002_return_optimistic_locking.sql
-- Fixes optimistic locking on vendor returns.
...
BEGIN
  ...
  IF _new_balance < 0 THEN
    RAISE EXCEPTION 'Insufficient funds to cover return debit';
  END IF;
