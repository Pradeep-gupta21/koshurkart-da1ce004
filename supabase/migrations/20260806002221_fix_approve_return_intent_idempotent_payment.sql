-- Migration: 20260806002221_fix_approve_return_intent_idempotent_payment.sql
-- Fixes payment lookup logic inside approve_return_intent to support idempotent replay
-- when the payment status has changed to refund-related states.
